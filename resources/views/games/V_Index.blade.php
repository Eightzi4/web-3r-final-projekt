{{-- Main layout component for the game management admin index page --}}
<x-layouts.v-main :title="'Manage Games'" :breadcrumbs="$breadcrumbs">

    {{-- Page header with title and "Add New Game" button --}}
    ...
    {{-- Table container for displaying the list of games --}}
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-xl overflow-x-auto">
        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
            ...
            {{-- Table body section, iterates through games --}}
            <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                @forelse ($games as $game)
                    {{-- Table row for each game entry --}}
                    <tr>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center">
                                <div class="flex-shrink-0 h-12 w-12">
                                    ...
                                    @else
                                        {{-- Placeholder image if no game image exists --}}
                ...
                @empty
                    {{-- Row displayed when no games are found --}}
                    <tr>
